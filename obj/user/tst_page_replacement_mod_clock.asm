...
//	cprintf("envID = %d\n",envID);
  ...
  800249:	68 6c 1c 80 00       	push   $0x801c6c
  ...
  8002d3:	68 b2 1c 80 00       	push   $0x801cb2
  8002d8:	6a 30                	push   $0x30
  ...
  8002fd:	3d 00 00 80 00       	cmp    $0x800000,%eax
  800302:	74 14                	je     800318 <_main+0x2e0>
  800304:	83 ec 04             	sub    $0x4,%esp
  800307:	68 b2 1c 80 00       	push   $0x801cb2
  80030c:	6a 31                	push   $0x31
  ...
  80033b:	68 b2 1c 80 00       	push   $0x801cb2
  800340:	6a 32                	push   $0x32
  ...
  80036f:	68 b2 1c 80 00       	push   $0x801cb2
  800374:	6a 33                	push   $0x33
  ...
  800399:	3d 00 c0 80 00       	cmp    $0x80c000,%eax
  80039e:	74 14                	je     8003b4 <_main+0x37c>
  8003a0:	83 ec 04             	sub    $0x4,%esp
  8003a3:	68 b2 1c 80 00       	push   $0x801cb2
  8003a8:	6a 34                	push   $0x34
  ...
  8003d7:	68 b2 1c 80 00       	push   $0x801cb2
  8003dc:	6a 35                	push   $0x35
  ...
  800401:	3d 00 70 80 00       	cmp    $0x807000,%eax
  800406:	74 14                	je     80041c <_main+0x3e4>
  800408:	83 ec 04             	sub    $0x4,%esp
  80040b:	68 b2 1c 80 00       	push   $0x801cb2
  800410:	6a 36                	push   $0x36
  ...
  80043f:	68 b2 1c 80 00       	push   $0x801cb2
  800444:	6a 37                	push   $0x37
  ...
  800473:	68 b2 1c 80 00       	push   $0x801cb2
  800478:	6a 38                	push   $0x38
  ...
  80048d:	83 f8 05             	cmp    $0x5,%eax
  800490:	74 14                	je     8004a6 <_main+0x46e>
  800492:	83 ec 04             	sub    $0x4,%esp
  800495:	68 d0 1c 80 00       	push   $0x801cd0
  80049a:	6a 3a                	push   $0x3a
  ...
  8004a9:	68 f0 1c 80 00       	push   $0x801cf0
...
libmain(int argc, char **argv)
{
  ...
  800512:	68 64 1d 80 00       	push   $0x801d64
...
_panic(const char *file, int line, const char *fmt,...)
{
  ...
  80059a:	50                   	push   %eax
  80059b:	68 a5 1d 80 00       	push   $0x801da5
  ...
  8005b3:	50                   	push   %eax
  8005b4:	68 aa 1d 80 00       	push   $0x801daa
  ...
  8005d6:	68 c6 1d 80 00       	push   $0x801dc6
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800793:	05 f4 1f 80 00       	add    $0x801ff4,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8008e6:	8b 04 85 18 20 80 00 	mov    0x802018(,%eax,4),%eax
  ...
  8009c7:	8b 34 9d 60 1e 80 00 	mov    0x801e60(,%ebx,4),%esi
  8009ce:	85 f6                	test   %esi,%esi
  8009d0:	75 19                	jne    8009eb <vprintfmt+0x173>
				printfmt(putch, putdat, "error %d", err);
  8009d2:	53                   	push   %ebx
  8009d3:	68 05 20 80 00       	push   $0x802005
  ...
  8009e6:	e9 49 02 00 00       	jmp    800c34 <vprintfmt+0x3bc>
			...
			if (err > MAXERROR || (p = error_string[err]) == NULL)
				...
				printfmt(putch, putdat, "%s", p);
  8009eb:	56                   	push   %esi
  8009ec:	68 0e 20 80 00       	push   $0x80200e
  ...
  800a17:	75 05                	jne    800a1e <vprintfmt+0x1a6>
				p = "(null)";
  800a19:	be 11 20 80 00       	mov    $0x802011,%esi
			if (width > 0 && padc != '-')
